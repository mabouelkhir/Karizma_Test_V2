...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './etape.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETAPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ETAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ETAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ETAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ETAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ETAPE actions', async () => {
      const expectedActions = [
        {
